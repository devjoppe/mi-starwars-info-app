...
// Interfaces
import {DetailVehiclesInt} from "../../../interfaces/DetailView.ts";
// MUI
import {Typography} from "@mui/material";
import Grid from "@mui/material/Unstable_Grid2";
interface IProp {
    detailData: DetailVehiclesInt
}
    ...
    return(
        <div className="sw-detail-infoboxes">
            ...
            <div className="sw-detail-main-info">
                <Typography>
                    {detailData.name} is of model {detailData.model} with the class of {detailData.vehicle_class}, and is manufactured by {detailData.manufacturer}.
                    The vehicle length is {detailData.length} meters and is operated by a crew of {detailData.crew} and can take {detailData.passengers} passengers.
                    The cargo capacity is {detailData.cargo_capacity} and can operate for {detailData.consumables}.
                    {detailData.name} has a top atmospheric speed of {detailData.max_atmosphering_speed} and the vehicle can be purchased for {detailData.cost_in_credits} credits.
                </Typography>
            </div>
